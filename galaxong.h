...
public:
    ...
    void actualizar_disparos(int puntos_obtenidos); // Actualiza la puntuación
    void actualizar_enemigos(int puntos_obtenidos); // Actualiza la puntuación
    ...
    // Declaración del método disparar
    void disparar(nave& nav, std::vector<bicho>& _bichos);  // Método para disparar
};
